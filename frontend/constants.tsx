...
export const Icons = {
    ...
    accounting: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V7a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2z" /></svg>,
    ...
    logo: <svg className="h-8 w-8 text-white" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5-10-5-10 5z" /></svg>,
...
export const NAV_ITEMS = [
    ...
    { page: Page.Inventory, label: 'Inventory', icon: Icons.inventory },
    { page: Page.Sales, label: 'Sales', icon: Icons.sales },
    { page: Page.Purchases, label: 'Purchases', icon: Icons.purchases },
    { page: Page.Accounting, label: 'Accounting', icon: Icons.accounting },
    { page: Page.Reports, label: 'Reports', icon: Icons.reports },
];
